# ramp/ — Provable Agent Spend (Codex project notes)
...
| --- | --- | --- |
| **`PITCH.md`** | **Canonical pitch — the single source of truth.** | Humans + every Codex session |
...
### Keeping the pitch in sync (IMPORTANT — applies to you and every other Codex session)
...
3. **Re-publish both artifacts to their existing URLs** (do not mint new ones):
   - Plan: `hackathon-plan.html` → artifact `https://Codex.ai/code/artifact/30f5b98e-903f-4f8d-80f6-aaab5d80a2de`
   - Deck: `pitch-deck.html` → artifact `https://Codex.ai/code/artifact/bd909a82-812b-4658-b976-7519a6209420`
...
hook, run **`pnpm demo`**: it spawns `hook/evaluate.mjs` as a real subprocess (exactly how Codex
